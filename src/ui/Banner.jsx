const Banner = (props) => {
  return (
    <section className="relative bg-[url(https://assets3.thrillist.com/v1/image/2809418/828x610/flatten;crop;webp=auto;jpeg_quality=60.jpg)] bg-cover bg-center bg-no-repeat">
